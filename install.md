...
Thanks to user "passcod" who created an GitHub Worklflow for that purpose, there is a weekly build of skopeo for windows availaible @ https://github.com/passcod/winskopeo/releases/latest/download/skopeo.exe 
