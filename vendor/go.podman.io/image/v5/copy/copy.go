...
// SetDigestOptions sets the digest options for this copy operation.
// This allows callers to force the use of a specific digest algorithm.
func (o *Options) SetDigestOptions(opts digests.Options) {
	o.digestOptions = opts
}

// SetForceDigestAlgorithm forces the use of a specific digest algorithm for this copy operation.
// algo should be one of "sha256", "sha384", or "sha512".
